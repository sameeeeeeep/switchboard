...
import { buildProject, projectToMarkdown, slugify } from "./project.mjs";
...
function gatherRepo(dir) {
  ...
  return { readme, pkgName: pkg.name, pkgDesc: pkg.description, version: pkg.version, license, links, stack, docs, packages, wrapps, roadmap, openTasks };
}
