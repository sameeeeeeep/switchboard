...
export default function FreehandLanding(){
 return <div className="v2" id="v2-top">
  ...
  <main id="v2-main">
   ...
   <ExampleShowcase/>
   <section id="v2-build" className="v2-builder"><span className="v2-kicker">FOR THE PEOPLE BUILDING</span><h2>Build the harness.<br/><em>Don’t worry about inference.</em></h2><div><p>Our bet: AGI is here. The harness is what matters now. Bring your own compute and combine the tools, context and capabilities your work needs.</p><a href="/developers" className="v2-primary">Build. Distribute. Earn. <ArrowUpRight size={16}/></a></div></section>
